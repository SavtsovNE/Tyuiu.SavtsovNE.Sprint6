...
namespace Tyuiu.SavtsovNE.Sprint6.Task0.V15
{
    public partial class FormMain : Form
    {
        ...
        private void buttonDone_KDR_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Вв едены неверные данные", "Ошибка", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }

        private void buttonHelp_KDR_Click(object sender, EventArgs e)
        {
            MessageBox.Show("Таск 0 выполнил студент группы ИБКСБ-24-1 Савцов Никита ЕВгеньевич ", "Сообщение", MessageBoxButtons.OK);
        }
