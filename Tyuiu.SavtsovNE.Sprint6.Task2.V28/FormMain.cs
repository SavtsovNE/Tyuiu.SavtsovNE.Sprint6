    ...
    public partial class FormMain : Form
    {
        ...
        private void buttonResult_LVA_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                this.checkedListBox1.Titles.Add("График функции ");
                this.checkedListBox1.ChartAreas[0].AxisX.Title = "Ось X";
                this.checkedListBox1.ChartAreas[0].AxisY.Title = "Ось Y";
        ...
        {
            MessageBox.Show("Таск 2 выполнил студент группы ИБКСб-24-1 Савцов Никита Евгеньевич", "Сообщение", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
